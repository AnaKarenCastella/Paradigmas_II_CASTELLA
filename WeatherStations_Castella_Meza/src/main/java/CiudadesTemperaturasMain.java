    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("F:\\weather_stations.csv"))) {
            ...
            while ((line = br.readLine()) != null) {
                String[] parts = line.split(";"); // Suponiendo que el archivo CSV está separado por punto y coma
                if (parts.length >= 2) { // Verificar que la línea tiene al menos dos elementos
